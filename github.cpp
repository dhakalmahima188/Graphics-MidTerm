...
//		float fFovRad = 1.0f / tanf(fFov * 0.5f) / 180.0f * 3.14149f; //degrees to radins 0.5 le khhai kina multiply gaero
//
//
...
//
//		Fill(0, 0, ScreenWidth(), ScreenHeight(), PIXEL_SOLID, FG_BLACK); //SCREEN CLEAR GAREKO
//
//
...
//
//			//scale to viewing area
//			///shifting betn 0 and 2
//
